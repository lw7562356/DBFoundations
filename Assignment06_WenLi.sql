...
-- 2025-03-05,Wen Li,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_WenLi')
	 Begin 
	  Alter Database [Assignment06DB_WenLi] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_WenLi;
	 End
	Create Database Assignment06DB_WenLi;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_WenLi;
...
SELECT TOP 100000
	vInventories.InventoryDate,
	MIN(vEmployees.EmployeeFirstName + ' ' + vEmployees.EmployeeLastName) AS EmployeeName
...
FROM vTmp JOIN vEmployeesByManager
ON vTmp.Employee = vEmployeesByManager.Employee
